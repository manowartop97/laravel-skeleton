...
namespace Manowartop\LaravelSkeleton\CodeGenerator\Templates\Model;
...
class ModelTemplate extends ClassTemplate implements TemplateInterface
{
    ...
    public function setNamespace(string $namespace): ClassTemplate
    {
        if (config('code_generator.model.is_create_entity_folder')) {
            return parent::setNamespace(
                config('code_generator.model.namespace') . "\\$namespace"
            );
        }

        return parent::setNamespace(
            config('code_generator.model.namespace')
        );
    }
    ...
    ): void
    {
        ...
        $this->addUse(config('code_generator.model.namespace') . "\\$className\\$className");
